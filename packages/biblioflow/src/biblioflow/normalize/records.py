...
_FIELD_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "pmid": ("pmid", "pubmed_id", "pubmedid", "PMID"),
    "pmcid": ("pmcid", "pmc_id", "pmc", "PMCID"),
    "title": ("title", "ti", "article_title", "article title", "t1"),
    "abstract": ("abstract", "ab", "summary", "notes", "n2"),
    "full_text": ("full_text", "full text", "body", "article_text", "text"),
    ...
    "full_text_url": ("full_text_url", "full text url", "pmc_url"),
